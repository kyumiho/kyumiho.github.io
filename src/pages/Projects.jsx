  ...
  return (
    <motion.div variants={variants}>
      <div
        ...
        style={{ padding: '44px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', transition: 'transform 0.15s ease', willChange: 'transform' }}
      >
    ...
    <main className="min-h-screen flex items-center py-20 md:py-28 px-6">
      <div style={{ maxWidth: '896px', margin: '0 auto' }}>
        <motion.div initial="hidden" animate="show" variants={stagger} style={{ width: '100%' }}>
          ...
          <motion.div variants={fadeUp} style={{ height: '1px', background: 'rgba(255,255,255,0.07)', marginBottom: '60px' }} />
